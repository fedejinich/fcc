use crate::codegen::x64::asm::AsmBinaryOperator::*;
use crate::codegen::x64::asm::AsmInstruction::*;
use crate::codegen::x64::asm::AsmOperand::*;

use crate::codegen::x64::asm::{AsmFunctionDefinition, AsmInstruction, Reg};

pub fn fix_function_definition(
